...
1. In the **Open** window, navigate to the **C:\LabFiles\DP-500-Azure-Data-Analyst\Allfiles\10\Solution\Starter** folder.
...
1. In the **Save As** window, navigate to the **C:\LabFiles\DP-500-Azure-Data-Analyst\Allfiles\10\Solution** folder.
