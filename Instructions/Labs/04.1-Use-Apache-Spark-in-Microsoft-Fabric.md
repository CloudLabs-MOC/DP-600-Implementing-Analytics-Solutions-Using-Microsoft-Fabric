...
1. At the bottom left of the portal, select **Data Engineering (1)** and again select **Data Engineering (2)** experience. In the **Synapse Data Engineering** home page, select **Lakehouse (3)**.

    ![Screenshot of uploaded files in a lakehouse.](./Images/dataengineering.png)

2. Follow these instructions to create a new **Lakehouse**:

   - **Name:** Enter **fabric_lakehouse<inject key="DeploymentID" enableCopy="false"/>**

   - Click on **Create**

3. Return to the web browser tab containing your lakehouse, and in the **...** menu for the **Files** folder in the **Explorer** pane, select **Upload** and **Upload folder**, and then upload the **orders** folder from **C:\LabFiles\Files\orders** to the lakehouse, and select **Upload**, and close the pane.
...
#### Task 5.2: Use dataframe methods and functions to transform data
...
#### Task 5.3: Save the transformed data
...
#### Task 5.4: Save data in partitioned files
...
#### Task 6.3: Run SQL code in a cell
